...
{
    public class UpdateProductCommandUnitTest : BaseMediator, ITest
    {
        ...
        public UpdateProductCommandUnitTest(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        ...
        {
            WriteTextCmd("UpdateProductCommandUnitTest");
        ...
        {
            person.IdCompany = product.IdCompany;
