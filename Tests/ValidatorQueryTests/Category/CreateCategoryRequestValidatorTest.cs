...
{
    public class CreateCategoryRequestValidatorTest() : BaseValidators, ITest
    {
        ...
        private CreateCategoryRequest request = new()
        {
        };
        ...
        {
            WriteTextCmd("CreateCategoryRequestValidatorTest");
